...
useradd -m -g $DEFAULT_GROUP -G wheel "$USERNAME" -s /usr/bin/zsh
...
chown $USERNAME:$DEFAULT_GROUP $XINITRC
chmod 644 $XINITRC
...
cat << EOF > $ZSHRC
feh --bg-scale ~/pictures/einstein.jpg
EOF

chown $USERNAME:$DEFAULT_GROUP $ZSHRC
chmod 644 $ZSHRC

I3CONFIG=/home/$USERNAME/.config/i3/config
mkdir -p $(dirname $I3CONFIG)
...
chown $USERNAME:$DEFAULT_GROUP $I3CONFIG
chmod 644 $I3CONFIG
